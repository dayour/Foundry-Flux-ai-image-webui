...
Run the consolidated diagnostics script to verify your setup end-to-end:
...
- Remote API checks only: `pnpm flux:diagnostics:remote`
- Local helper checks only: `pnpm flux:diagnostics:local`

You can also call the script directly for custom flags:
