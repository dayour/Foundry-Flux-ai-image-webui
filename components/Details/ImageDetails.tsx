    ...
    return (
        <>
            <div className="md:grid md:grid-cols-2 md:gap-12 xl:gap-16 mt-12">
                {/* Left Col */}
                <div className="group relative flex flex-col w-full min-h-96 flex-1 bg-gray-100 dark:bg-neutral-900  rounded-xl items-center justify-center overflow-hidden">
                    {/* {!generation ? (
                    ...
                    <>
                                                <ControlledZoom isZoomed={isZoomed} onZoomChange={handleZoomChange}>
                                                                            <div className="relative w-full h-[480px]">
                                                                                <NextImage src={generation.url} alt={generation.prompt || "Generated image"} fill className="object-contain object-center" unoptimized />
                                                                            </div>
                                                </ControlledZoom>
                        {/* Button Grouop */}
                ...
                <div className="relative">
                    {/* Right Card */}
                    <div className="flex flex-col border rounded-xl p-4 sm:p-6 lg:p-10 space-y-4 sm:space-y-6 dark:border-neutral-700">
